export default {
  ...
  'menu.basic-data.edit-schedule': '课表方案',
  ...
  'menu.rule': '排课规则定义',
  'menu.rule.class': '班级固排禁排',
  'menu.rule.teacher': '教师固排禁排',
  'menu.rule.subject': '科目优先排禁排',
  'menu.rule.facility': '场地优先排禁排',
  'menu.rule.teacher-special': '教师特殊排课要求',
  'menu.rule.subject-special': '科目特殊排课要求',

  'menu.course-schedule': '智能排课',
};
